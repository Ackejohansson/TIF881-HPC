  ...
  for ( size_t ib = 0; ib < num_points; ib += BLOCK_SIZE ) {
    ...
    for ( size_t jb = 0; jb < num_points-ib; jb += BLOCK_SIZE ) {
      ...
      for ( size_t ix = 0; ix < ie; ++ix ){
        ...
        for ( size_t jx = 0; jx < je_inner; jx+=4 ) {
          float squared_dist1 =  ((block1[ix][0] - block2[jx][0]) * (block1[ix][0] - block2[jx][0]))
                              + ((block1[ix][1] - block2[jx][1]) * (block1[ix][1] - block2[jx][1])) 
                              + ((block1[ix][2] - block2[jx][2]) * (block1[ix][2] - block2[jx][2]));

          float squared_dist2 = ((block1[ix][0] - block2[jx+1][0]) * (block1[ix][0] - block2[jx+1][0]))
                              + ((block1[ix][1] - block2[jx+1][1]) * (block1[ix][1] - block2[jx+1][1])) 
                              + ((block1[ix][2] - block2[jx+1][2]) * (block1[ix][2] - block2[jx+1][2]));
          
          float squared_dist3 = ((block1[ix][0] - block2[jx+2][0]) * (block1[ix][0] - block2[jx+2][0]))
                              + ((block1[ix][1] - block2[jx+2][1]) * (block1[ix][1] - block2[jx+2][1])) 
                              + ((block1[ix][2] - block2[jx+2][2]) * (block1[ix][2] - block2[jx+2][2]));

          float squared_dist4 = ((block1[ix][0] - block2[jx+3][0]) * (block1[ix][0] - block2[jx+3][0]))
                              + ((block1[ix][1] - block2[jx+3][1]) * (block1[ix][1] - block2[jx+3][1])) 
                              + ((block1[ix][2] - block2[jx+3][2]) * (block1[ix][2] - block2[jx+3][2]));                    

          int dist1 = (int)(sqrtf(squared_dist1)*0.1f + 0.5f);
          int dist2 = (int)(sqrtf(squared_dist2)*0.1f + 0.5f);
          int dist3 = (int)(sqrtf(squared_dist3)*0.1f + 0.5f);
          int dist4 = (int)(sqrtf(squared_dist4)*0.1f + 0.5f);
