    ...
    for ( size_t jb = 0; jb < num_points-ib; jb += BLOCK_SIZE ) {
      ...
      for ( size_t ix = 0; ix < ie; ix+=4 ){
        ...
        for ( size_t jx = 0; jx < je_inner; ++jx ) {
          ...
          float squared_dist3 =  ((block1[ix+2][0] - block2[jx][0]) * (block1[ix+2][0] - block2[jx][0]))
                              + ((block1[ix+2][1] - block2[jx][1]) * (block1[ix+2][1] - block2[jx][1])) 
                              + ((block1[ix+2][2] - block2[jx][2]) * (block1[ix+2][2] - block2[jx][2]));
                              
          float squared_dist4 =  ((block1[ix+3][0] - block2[jx][0]) * (block1[ix+3][0] - block2[jx][0]))
                              + ((block1[ix+3][1] - block2[jx][1]) * (block1[ix+3][1] - block2[jx][1])) 
                              + ((block1[ix+3][2] - block2[jx][2]) * (block1[ix+3][2] - block2[jx][2]));
