...
static inline double complex fdiv(double complex x, int d){
  switch(d) {
    case 1:
      return x - 1.0;
    case 2:
    ...
    case 3:
      xsq = x*x;
      return (x*xsq-1.)/(3.*xsq);
    case 4:
      xsq = x*x;
      return (xsq*xsq-1.0)/(4.*xsq*x);
    case 5:
      xsq = x*x;
      return (xsq*xsq*x-1.)/(5.*xsq*xsq);
    default:
      printf("d unknown");
 }
/*  switch(d) {
